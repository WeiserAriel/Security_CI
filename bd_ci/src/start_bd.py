...
def main():
    ...
    parser.add_argument('--project',choices=['UFM','MOFED','NEO','MFT','UFMAPL','MLNX_OS','HPCX','OPENSM','SHARP','IBUTILS2','BlueField'] , dest='project', help='select a project from list')
