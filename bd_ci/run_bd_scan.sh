...
echo  "Setting env variables from configuration file...."
DIRECTORY=`dirname $0`
...
##change sinppet back to true
export DETECT_SCAN_FLAGS="--detect.blackduck.signature.scanner.snippet.mode=false --detect.excluded.detector.types=nuget,bazel,docker --detect.tools=SIGNATURE_SCAN,DETECTOR"
